      ...
      if(sample.recurrence==="weekly" && (sample.recurWeekdays||[]).length && daysUntilEnd < 21){
        ...
        while(cursor<=end){
          if(sample.recurWeekdays.includes(cursor.getDay())){
            toAdd.push({...sample,id:gid(),date:ymd(cursor),status:"pending",actualStart:null,actualEnd:null,actualHours:null,photos:[],signature:null});
          }
        ...
        for(let i=1;i<=6;i++){
          ...
          toAdd.push({...sample,id:gid(),date:ymd(d),status:"pending",actualStart:null,actualEnd:null,actualHours:null,photos:[],signature:null});
        }
      }
    });
    if(toAdd.length){
