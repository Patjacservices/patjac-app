...
const PATJAC_LOGO = "data:image/png;base64,";
...
const GAV_CATEGORIES = [
  {id:"reinigung_I",   label:"Unterhaltsreinigung I",            hourly:20.50, monthly:null, sector:"reinigung",
  ...
  {id:"reinigung_II",  label:"Unterhaltsreinigung II",           hourly:21.80, monthly:null, sector:"reinigung",
  ...
  {id:"spezial_I",     label:"Spezialreinigung I",               hourly:22.70, monthly:null, sector:"reinigung",
  ...
  {id:"spezial_II",    label:"Spezialreinigung II",              hourly:23.70, monthly:null, sector:"reinigung",
  ...
  {id:"spital_I",      label:"Spitalreinigung I",                hourly:21.20, monthly:null, sector:"reinigung",
  ...
  {id:"spital_II",     label:"Spitalreinigung II",               hourly:22.20, monthly:null, sector:"reinigung",
  ...
  {id:"fahrzeug_I",    label:"Fahrzeugreinigung I",              hourly:22.50, monthly:null, sector:"reinigung",
  ...
  {id:"fahrzeug_II",   label:"Fahrzeugreinigung II",             hourly:23.50, monthly:null, sector:"reinigung",
  ...
  {id:"eba",           label:"EBA Gebäudereiniger/in",           hourly:22.00, monthly:4000, sector:"reinigung",
  ...
  {id:"efz",           label:"EFZ Gebäudereiniger/in",           hourly:23.50, monthly:4300, sector:"reinigung",
        ...
        <CPModal title={selId?t.edit:t.add} onClose={()=>setModal(null)} width={560}>
          ...
          <CPField label={L("GAV-Lohnkategorie","Categoría salarial GAV","GAV Salary Category","Categoria salariale GAV")}>
            <CPSelect value={form.gavCategory||""} onChange={e=>{
              ...
              <optgroup label="🧹 GAV Reinigung Deutschschweiz 2025">
                <option value="reinigung_I">Unterhaltsreinigung I — CHF 20.50/h</option>
                <option value="reinigung_II">Unterhaltsreinigung II — CHF 21.80/h</option>
                <option value="spezial_I">Spezialreinigung I — CHF 22.70/h</option>
                <option value="spezial_II">Spezialreinigung II — CHF 23.70/h</option>
                <option value="spital_I">Spitalreinigung I — CHF 21.20/h</option>
                <option value="spital_II">Spitalreinigung II — CHF 22.20/h</option>
                <option value="fahrzeug_I">Fahrzeugreinigung I — CHF 22.50/h</option>
                <option value="fahrzeug_II">Fahrzeugreinigung II — CHF 23.50/h</option>
                <option value="eba">EBA Gebäudereiniger/in — CHF 22.00/h (CHF 4'000/M)</option>
                <option value="efz">EFZ Gebäudereiniger/in — CHF 23.50/h (CHF 4'300/M)</option>
...
function InvoicesApp({t,invoices,setInvoices,clients,notify,onBack,lang}){
  ...
  const calc=(items)=>{const s=items.reduce((a,i)=>a+(i.total||0),0);return{s:s.toFixed(2),v:(s*.081).toFixed(2),t:(s*1.081).toFixed(2)};};
          ...
          <div className="invoice-preview-content" style={{background:"#fff",color:"#000",padding:"24px",borderRadius:14,fontFamily:"Arial,sans-serif"}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:20}}>
              <div>
                ...
                <div style={{fontSize:11,marginTop:6}}><div>Industriestrasse 14, 8004 Zürich</div><div>+41 44 123 4567</div><div>UID: CHE-123.456.789 MWST</div></div>
              </div>
...
function FinanceApp({t,invoices,employees,timeclock,expenses,setExpenses,orders,notify,onBack,lang}){
  ...
  const mwstInput = manualExpenses * 0.081; // recoverable input VAT on expenses
    ...
    <CPScreen title={t.stockTitle||"Inventory"} icon="📦" onBack={onBack} t={t}
      actions={
        <div style={{display:"flex",gap:8}}>
          ...
          {view==="orders"&&<CPBtn onClick={()=>{setForm({supplierId:"1f308250-7d3c-4765-8af0-35d1285255d0",date:new Date().toISOString().split("T")[0],deliveryDate:new Date(Date.now()+7*86400000).toISOString().split("T")[0],items:[],notes:""});setModal("order");}} size="sm">＋ {t.addOrder||"Order"}</CPBtn>}
...
function ContractsApp({t,lang,clients,employees,companySettings,notify,onBack,currentUser,contracts,setContracts}){
  ...
  const openNew = (tp) => {
    ...
    setForm({
      ...
      trialPeriod: tp==="employee"?trialEnd.toISOString().split("T")[0]:"",
  ...
  const buildContractHTML = (c) => {
    ...
    const articles = isEmp ? [
      ...
      [L("Art. 5 – Ferien","Art. 5 – Vacaciones","Art. 5 – Annual Leave","Art. 5 – Ferie"),
       L(
        "Der/Die Arbeitnehmer/in hat Anspruch auf 4 Wochen bezahlten Urlaub pro Jahr (Art. 329a OR). Für Mitarbeitende unter 20 Jahren gelten 5 Wochen. Die Ferientermine werden in Absprache mit dem Arbeitgeber festgelegt.",
        "El/La empleado/a tiene derecho a 4 semanas de vacaciones pagadas al año (Art. 329a CO). Para menores de 20 años aplican 5 semanas. Las fechas se acuerdan con el empleador.",
        "The employee is entitled to 4 weeks of paid annual leave per year (Art. 329a CO). Employees under 20 years of age are entitled to 5 weeks. Leave dates are agreed with the employer.",
        "Il/La dipendente ha diritto a 4 settimane di ferie pagate all'anno (Art. 329a CO). Per i dipendenti sotto i 20 anni si applicano 5 settimane. Le date delle ferie vengono concordate con il datore di lavoro."
      )],
...
<div class="footer-bar">
  ...
  <span>${L("Seite","Página","Page","Pagina")} 1 / 1</span>
</div>
</body></html>`;
  };
